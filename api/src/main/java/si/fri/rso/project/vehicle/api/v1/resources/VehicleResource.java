...
public class VehicleResource {
    ...
    public Response createVehicle(@RequestBody(
        ...
        if ((vehicle.getLstCharge() == null || vehicle.getModel() == null || vehicle.getNumOfKilometers() == null || vehicle.getNumOfChargesLstMonth() == null)) {
        ...
        return Response.status(Response.Status.CONFLICT).entity(vehicle).build();
